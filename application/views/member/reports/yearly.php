...
<head>
    ...
    <title>Yearly Report - IKIMINA</title>
        ...
        <div class="report-content">
            <div class="report-header">
                ...
                <div class="report-navigation">
                    <a href="<?php echo BASE_URL; ?>member/reports/weekly">Weekly</a>
                    <a href="<?php echo BASE_URL; ?>member/reports/monthly">Monthly</a>
                    <a href="<?php echo BASE_URL; ?>member/reports/yearly" class="active">Yearly</a>
                    <a href="<?php echo BASE_URL; ?>member/reports/downloadYearlyPDF" style="background: #10b981;" onmouseover="this.style.background='#059669';" onmouseout="this.style.background='#10b981';">📥 Download PDF</a>
                </div>
            </div>

            <!-- Current Balance Card -->
            <div style="background: linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%); border-radius: 16px; padding: 30px; margin-bottom: 30px; color: white; box-shadow: 0 10px 40px rgba(139, 92, 246, 0.3);">
            ...
            <!-- Additional Summary Cards for Yearly -->
            <div class="summary-cards">
                <div class="summary-card">
                    <h3>Total Loans</h3>
                    <p class="value">RWF <?php echo number_format($report['summary']['total_loans'], 2); ?></p>
                </div>
                <div class="summary-card">
                    <h3>Loan Payments</h3>
                    <p class="value">RWF <?php echo number_format($report['summary']['total_loan_payments'], 2); ?></p>
                </div>
                <div class="summary-card">
                    <h3>Total Savings</h3>
                    <p class="value">RWF <?php echo number_format($report['summary']['total_savings'], 2); ?></p>
                </div>
                <div class="summary-card">
                    <h3>Average Transaction</h3>
                    <p class="value">RWF <?php echo number_format($report['summary']['average_transaction'], 2); ?></p>
                </div>
            </div>
            ...
            <div class="report-section">
                ...
                <table class="transactions-table">
                    ...
                    <tbody>
                        <?php foreach (array_slice($report['transactions'], 0, 20) as $transaction): ?>
                        <tr>
