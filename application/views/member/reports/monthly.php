...
<head>
    ...
    <title>Monthly Report - IKIMINA</title>
        ...
        <div class="report-content">
            <div class="report-header">
                ...
                <div class="report-navigation">
                    ...
                    <a href="<?php echo BASE_URL; ?>member/reports/monthly" class="active">Monthly</a>
                    <a href="<?php echo BASE_URL; ?>member/reports/yearly">Yearly</a>
                    <a href="<?php echo BASE_URL; ?>member/reports/downloadMonthlyPDF" style="background: #10b981;" onmouseover="this.style.background='#059669';" onmouseout="this.style.background='#10b981';">📥 Download PDF</a>
                </div>
            </div>

            <!-- Current Balance Card -->
            <div style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); border-radius: 16px; padding: 30px; margin-bottom: 30px; color: white; box-shadow: 0 10px 40px rgba(16, 185, 129, 0.3);">
            ...
            <div class="report-section">
                ...
                <table class="transactions-table">
                    ...
                    <tbody>
                        <?php foreach (array_slice($report['transactions'], 0, 15) as $transaction): ?>
                        <tr>
