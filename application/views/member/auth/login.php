...
<head>
    ...
    <title>Member Login - IKIMINA Financial Management System</title>
...
<div class="auth-container">
    <div class="auth-box">
        ...
        <div class="auth-form">
            ...
            <form id="loginForm" method="POST" action="<?php echo BASE_URL; ?>member/auth/login">
            ...
            <div class="auth-footer">
                <p>Don't have an account? <a href="<?php echo BASE_URL; ?>member/auth/register">Create Account</a></p>
                <a href="<?php echo BASE_URL; ?>admin/auth/login" class="admin-link">
