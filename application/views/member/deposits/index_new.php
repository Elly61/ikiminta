...
<head>
    ...
    <title>My Deposits - IKIMINA</title>
    ...
    <div class="main-content">
        ...
        <div class="dashboard-content" style="padding: 30px;">
            <div class="content-header">
                <h1>💳 My Deposits</h1>
                <a href="<?php echo BASE_URL; ?>member/deposits/create" class="btn-new">
                    ➕ New Deposit
                </a>
            </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php if (!empty($deposits)): ?>
                            ...
                            <tr>
                                <td><?php echo date('M d, Y', strtotime($deposit['created_at'] ?? 'now')); ?></td>
                                <td>
                                    <strong>RWF <?php echo number_format($deposit['amount'], 2); ?></strong>
                                </td>
                                ...
                                <td>
                                    <code style="background: #f0f0f0; padding: 4px 8px; border-radius: 4px; font-size: 12px;">
                                        <?php echo substr($deposit['transaction_reference'], 0, 12); ?>...
                                    </code>
                                </td>
                                <td>
                                    <?php
                                    ...
                                    <?php if (!empty($proofPath)): ?>
                                        <a href="<?php echo BASE_URL . $proofPath; ?>" target="_blank" class="proof-link">
                                            📎 View proof
                                        </a>
                                    <?php else: ?>
                                ...
                                <td>
                                    <span class="status <?php echo strtolower($deposit['status']); ?>">
                                        <?php 
                                ...
                                <td>
                                    <a href="<?php echo BASE_URL; ?>member/deposits/view/<?php echo $deposit['id']; ?>" class="action-link">
                                        View Details →
                                    </a>
                                </td>
                            </tr>
